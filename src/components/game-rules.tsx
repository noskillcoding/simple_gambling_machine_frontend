...
const depositTiers = [
	{ tier: 1, deposits: "1-50", percentage: "2%", timeout: "24h" },
	{ tier: 2, deposits: "51-125", percentage: "1.5%", timeout: "16h" },
	{ tier: 3, deposits: "126-225", percentage: "1.2%", timeout: "12h" },
	{ tier: 4, deposits: "226-425", percentage: "1%", timeout: "6h" },
	{ tier: 5, deposits: "426-925", percentage: "0.5%", timeout: "3h" },
	{ tier: 6, deposits: "926-1925", percentage: "0.2%", timeout: "2h" },
	{ tier: 7, deposits: "1926+", percentage: "0.05%", timeout: "1h" },
];
						...
						<AccordionContent>
							<div className="space-y-2">
								...
								<ul className="ml-4 list-inside list-disc space-y-1">
									...
									<li>
										<strong>Random Winners (10%):</strong> 5 random depositors from the last 5,096 depositors
										share 10% of the pot
									</li>
								</ul>
