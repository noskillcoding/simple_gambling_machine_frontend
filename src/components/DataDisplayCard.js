...
export default function DataDisplayCard({ label, value, unit = "", prominent = false }) {
  ...
  const labelSize = prominent ? "text-[1.4vh] sm:text-[1.5vh]" : "text-[1.2vh] sm:text-[1.4vh]";
  const valueSize = prominent ? "text-[2.2vh] sm:text-[2.7vh]" : "text-[1.8vh] sm:text-[1.7vh]";
